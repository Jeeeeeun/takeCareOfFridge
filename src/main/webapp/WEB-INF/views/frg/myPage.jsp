			...
			<div>
				...
				<div class="myPageContentBox1">
					...
					<div class="myEmailBox">
						...
						<button class="duplicateBtn" id="checkEmail" type="button" style="margin-bottom: -7%; margin-left: -11%; display: none;">
							중복확인
						</button>
					</div>
				...
				<div class="myPageContentBox3">
					...
					<form action="${pageContext.servletContext.contextPath}/frg/trfStandardChange" method="post" id="standardDate">
						<div id="standards-wrapper">
							<div class="dangerous-standard">
								<input type="number" id="dangerousStandard" disabled />
								<span id="dangerousSpan"></span>
							</div>
							<div class="warning-standard">
								<input type="number" id="warningStandard" disabled />
						...
						<div>
							<button type="button" id="trfCorrectionEndBtn" onclick="trfCorrectionEnd()">수정 완료</button>
						</div>
					</form>
					...
					<div id="fridgeInfoContentBox">
						...
						<form action="${ pageContext.servletContext.contextPath }/frg/frgInfoChange" method="post" id="frgInfoRight">
							...
							<div>
								<button type="button" id="frgInfoCorrectionEndBtn" onclick="frgCorrectionEnd()">
									수정 완료
								</button>
							</div>
						</form>
