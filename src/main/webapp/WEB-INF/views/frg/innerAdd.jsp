...
<html lang="ko">
	<head>
		...
		<script type="text/javascript"  src="${pageContext.servletContext.contextPath}/resources/js/innerFoodAdd3.js"></script>
	</head>
	<body id="page-top">
						...
						<div class="addSettingBox-Left">
							<div class="addSettingBox-Form">
								<div class="addSettingBox-Count-Plus">
									...
									<p>총&nbsp;
										<span id="totalFormsCount">1</span>
										개 등록 대기
									</p>
								</div>
								<form action="${pageContext.servletContext.contextPath}/frg/innerAdd/submit" method="post" id="actionForm">
												...
												<div class="addSettingBoxForm-boxes">
													<div class="addSettingBoxForm-boxes-arrange">
														...
														<div class="box2">
															...
															<div class="box2-1">
																<input type="radio" name="in_state-0" id="foodStateFrozen-0" value="frozen" checked />냉동
																<input type="radio" name="in_state-0" id="foodStateCool-0" value="cool" />냉장
															</div>
														</div>
														...
														<div class="box3">
															...
															<div class="box3-1">
																<div class="box3-2">
																	<input type="text" name="in_name-0" id="foodNameInput-0" placeholder="검색 결과가 입력됩니다." disabled />
																</div>
																<div class="box3-3">
																	<input type="checkbox" id="checkCustomInput-0" onclick="checkCustomOrNot();">직접입력하기
																</div>
															</div>
														</div>
														...
														<!-- 유통/소비기한 -->
														<div class="box4">
															<label for="dueDate-0"> 유통/소비기한 </label>
															<input type="date" name="in_expireDate-0" id="dueDate-0" value="">
														</div>
													
														<!-- 식품유형 -->
														<div class="box5">
															<label for="foodType-0"> 식품유형 </label>
															<input type="text" name="in_type-0" id="foodType-0" placeholder="검색 결과가 입력됩니다." disabled>
														</div>
													
														<!-- 수량 -->
														<div class="box6">
															<label for="foodCount-0"> 수량 </label>
															<input type="number" name="in_count-0" id="foodCount-0" min="1" placeholder="식품 수량 등록">
														</div>
													
														<!-- 제조사명 -->
														<div class="box7">
															<label for="foodCompany-0"> 제조사명 </label>
								...
								<div class="tableBox">
									<div class="searchFood">
										...
										<div class="searchFood-1">
											<input type="search" name="searchFood" id="searchInput" placeholder="식품을 검색하세요." autofocus />
											<button type="button" name="searchFoodBtn" id="searchSubmit" onclick="searchFoodAPI();">
												검색하기
											</button>
										</div>
										<!-- searchFood-1 끝 -->
