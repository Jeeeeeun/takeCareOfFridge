	...
	<header class="masthead">
		...
		<form
			...
			<div id="formBackground">
				<!-- 냉장고 목록 -->
				<label> <select name="frgList" id="frgOption">
				...
				<!-- 보관 위치 -->
				<input type="radio" id="foodStateFrozen"/>냉동 
				<input type="radio" id="foodStateCool"/>냉장 <br>
				<!-- 식품명 -->
				<label> <input type="search" id="searchInput" autofocus />
					...
					onclick="checkCustomOrNot();" />직접 입력하기
				</label> <br>
				<!-- 유통/소비기한 -->
				<label> <input type="text" id="dueDateAuto"
					placeholder="유통/소비기한"> <br> 
					<input type="date" id="dueDateCustom" >
				</label> <br>
				<!-- 식품유형 -->
				<label> <input type="text" id="foodType" placeholder="식품 유형 안내">
				</label> <br>
				<!-- 수량 -->
				<label> <input type="number" id="foodCount" placeholder="식품 수량 등록">
				</label> <br>
				<!-- 제조사명 -->
				<label> <input type="text" id="foodCompany" placeholder="제조사명 안내" >
				</label> <br>
				<!-- 추가, 완료 버튼 -->
