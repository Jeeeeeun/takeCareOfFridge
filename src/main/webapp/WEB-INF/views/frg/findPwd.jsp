...
<html lang="ko">
	<head>
		...
		<script src="${ pageContext.servletContext.contextPath }/resources/js/findPwd.js"></script>
	</head>
	<body id="page-top">
		<!-- Navigation-->
		...
		<div id="customAlert" class="hidden position-fixed top-0 start-0 w-100 h-100 bg-black-50 z-5 transition-opacity transition-duration-03 transition-timing-easeOut">
			...
			<div class="d-flex align-items-sm-center justify-content-sm-center text-center bg-white py-2 rounded-3 w-40 h-20 position-absolute top-50 start-50 translate-middle text-keepAll text-prewrap z-10 transition-all transition-duration-03 transition-timing-easeOut shadow-forAlert">
				<p id="alertContent" class="m-auto fs-5">
					알림창!
				</p>
			</div>
		</div>
				...
				<div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
					...
					<div class="col-lg-8 align-self-baseline">
						<div class="loginBox">
							...
							<form action="<%=request.getContextPath()%>/frg/findPwd" method="post">
								<input type="text" id="user_email" name="user_email" class="inputBox h4" placeholder="EMAIL" required style="margin-bottom: 20px; margin-left:86px; border-radius: 20px;">
								...
								<input type="text" id="certification_number" name="certification_number" class="inputBox h4" placeholder="Crtification_Number" required style="margin-bottom: 20px; margin-left:60px; border-radius: 20px;">
								<button class="duplicateBtn btn btn-primary" id="checkCode" type="button">
									확인
								</button>
								<br>
								...
								<input type="password" id="user_pw" name="user_pw" class="inputBox h4" placeholder="PW" required style="margin-bottom: 20px; border-radius: 20px;" disabled>
								<br>
								<input type="password" id="verifyPwd" name="verifyPwd" class="inputBox h4" placeholder="PW CHECK" required style="margin-bottom: 20px; border-radius: 20px;" disabled>
								<span class="pwdAlert" id="pwdAlert" style="margin-left: 10px; margin-top: 8px; position: absolute;"></span>
								<br>
							</form>
							<div class="box-submit">
								<button type="button" class="signUpBtn btn btn-success" id="submitButton" style="border-radius: 20px;" disabled>
									변경하기
								</button>
							</div>
						</div>
