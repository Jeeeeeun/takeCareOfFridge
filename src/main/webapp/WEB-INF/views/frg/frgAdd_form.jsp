					...
					<div class="settingBox">
						...
						<div class="setting-itemBox">
							...
							<label for="horizon_0"> <img id="ho_0" class="ho"
								...
								alt="가로형 냉장고" />
							</label> <input type="radio" name="frg_shape_0" id="vertical_0" value="V"
								onclick="radioClicked(event, this.nextElementSibling)">
							<label for="vertical_0"> <img id="ve_0" class="ve"
								src="${ pageContext.servletContext.contextPath }/resources/img/vFrgLabel.svg"
								alt="세로형 냉장고" />
							</label> <input type="radio" name="frg_shape_0" id="single_0" value="S"
								onclick="radioClicked(event, this.nextElementSibling)">
						...
						<div class="setting-itemBox">
							...
							<div class="fridge-info">
								<div class="fridgeInfoBox">
									<label class="fridgeInfoLabelName" for="frg_name_0"
										style="margin-top: 33px;">이름</label> <input
										class="fridgeInfoInput" id="frg_name_0" name="frg_name_0"
										required /><br> <label class="fridgeInfoLabelState">A</label>
									...
									<br> <label class="fridgeInfoLabelState">B</label>
