	...
	<header class="custom-masthead">
		...
		<div class="d-flex flex-row position-relative mt-6">
			...
			<form
				...
				onsubmit="submitBtnClicked(event)">
				<div class="settingBoxWrapper">
					<div class="settingBox">
						<div class="setting-titleBox">냉장고 모양</div>
						<div class="setting-itemBox">
							<div>
								<input type="radio" name="frg_shape_0" id="horizon_0" value="H"
									onclick="radioClicked(event, this.nextElementSibling)">
								<label for="horizon_0"> <img id="ho_0" class="ho"
									alt="가로형 냉장고" src="${ pageContext.servletContext.contextPath }/resources/img/hFrgLabel.svg" />
								</label>
							</div>
							<div>
								<input type="radio" name="frg_shape_0" id="vertical_0" value="V"
									onclick="radioClicked(event, this.nextElementSibling)">
								<label for="vertical_0"> <img id="ve_0" class="ve"
									alt="세로형 냉장고" src="${ pageContext.servletContext.contextPath }/resources/img/vFrgLabel.svg" />
								</label>
							</div>
							<div>
								<input type="radio" name="frg_shape_0" id="single_0" value="S"
									onclick="radioClicked(event, this.nextElementSibling)">
								<label for="single_0"> <img id="si_0" class="si"
									alt="단일형 냉장고" src="${ pageContext.servletContext.contextPath }/resources/img/sFrgLabel.svg">
								</label>
							</div>
						</div>
							...
							<div class="fridge-info">
								<div class="fridgeInfoBox">
									<div class="w-100">
										...
										<input class="fridgeInfoInput" id="frg_name_0"
											name="frg_name_0" required />
									</div>
									<div class="w-100">
										<label class="fridgeInfoLabelState">A</label>
										<button type="button" name="frg_Astate_0" value="cool"
											class="stateSelectBtn" onclick="stateBtnClicked(this, 0)">냉장</button>
										<button type="button" name="frg_Astate_0" value="frozen"
											class="stateSelectBtn" onclick="stateBtnClicked(this, 0)">냉동</button>
									</div>
									<div class="w-100">
										<label class="fridgeInfoLabelState">B</label>
										<button type="button" name="frg_Bstate_0" value="cool"
											class="stateSelectBtn" onclick="stateBtnClicked(this, 0)">냉장</button>
										<button type="button" name="frg_Bstate_0" value="frozen"
											class="stateSelectBtn" onclick="stateBtnClicked(this, 0)">냉동</button>
									</div>
								</div>
							</div>
